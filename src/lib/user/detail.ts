...
import { UserListComponent } from 'xl-auth';
...
@Component({
    ...
    providers: [],
    template: ` <p-dialog [visible]="detailService.isVisible()" (visibleChange)="detailService.closeDetail()" [modal]="true" [style]="{ width: '500px' }">
